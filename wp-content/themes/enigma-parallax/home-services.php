...
<div  id="service" <?php if($wl_theme_options['slider_home'] != "1") { ?> style="padding-top:240px !important;" <?php } ?>></div>
		...
		<div class="row isotope" id="isotope-service-container">		
			...
			<div class=" col-md-4 service">
				<div class="enigma_service_area appear-animation bounceIn appear-animation-visible">
					<?php if($wl_theme_options['service_'.$i.'_icons'] !='') { ?><a href="<?php echo esc_url($wl_theme_options['service_'.$i.'_link']); ?>"><div class="enigma_service_iocn pull-left"><i class="<?php echo esc_attr($wl_theme_options['service_'.$i.'_icons']); ?>"></i></div></a><?php } ?> 
