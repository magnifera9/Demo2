...
<div class="enigma_blog_area" <?php if($wl_theme_options['upload__blog_image']!=''){ echo 'style="background-image:url('.$wl_theme_options['upload__blog_image'].');"'; }?> <?php if($wl_theme_options['slider_home'] != "1" && $wl_theme_options['service_home'] != "1" && $wl_theme_options['portfolio_home'] != "1" && $wl_theme_options['show_testimonial'] != "1") { ?> style="padding-top:204px !important; border-top:0px solid !important;" <?php } ?>>
	<?php 
	...
	<div class="container">
		...
		<?php 	if ( have_posts()) : 			
				...
				<div class="enigma_blog_thumb_wrapper">
					<div class="enigma_blog_thumb_wrapper_showcase">					
						<?php $img = array('class' => 'enigma_img_responsive');
								...
								the_post_thumbnail('enigma_parallax_home_post_thumb',$img);
						endif; ?>
						<div class="enigma_blog_thumb_wrapper_showcase_overlay">
							<div class="enigma_blog_thumb_wrapper_showcase_overlay_inner ">
								<div class="enigma_blog_thumb_wrapper_showcase_icons">
									<a title="<?php the_title_attribute(); ?>" href="<?php esc_url(the_permalink()); ?>"><i class="fa fa-link"></i></a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="enigma_blog_thumb_wrapper">
					...
					<h2><a href="#"><?php _e('NO Post','enigma-parallax'); ?></a></h2>
					
					<div class="enigma_tags">
						<?php _e('Tags :&nbsp;','enigma-parallax'); ?>
						<a href="#"><?php _e('Bootstrap','enigma-parallax'); ?></a>
						<a href="#"><?php _e('HTML5','enigma-parallax'); ?></a>
					   
					</div>
					<p><?php _e('Add You Post To show post here..','enigma-parallax'); ?></p>
					<a href="#" class="enigma_blog_read_btn"><i class="fa fa-plus-circle"></i><?php if($wl_theme_options['read_more']) { echo esc_attr($wl_theme_options['read_more']); } ?></a>
					<div class="enigma_blog_thumb_footer">
						<ul class="enigma_blog_thumb_date">
							<li><i class="fa fa-user"></i><a href="#"><?php _e('By Admin','enigma-parallax'); ?></a></li>
							<li><i class="fa fa-clock-o"></i><?php _e(' November 9 2013','enigma-parallax'); ?></li>
							<li><i class="fa fa-comments-o"></i><a href="#"><?php _e('10','enigma-parallax'); ?></a></li>
						</ul>
					</div>
				</div>
				</div>
