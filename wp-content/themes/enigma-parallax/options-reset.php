...
{
	$wl_theme_options['footer_customizations']="@ 2015 enigma-parallax Theme";
	$wl_theme_options['developed_by_text']="Theme Developed By";
	$wl_theme_options['developed_by_weblizar_text']="enigma-parallax";
	$wl_theme_options['developed_by_link']="http://enigma-parallax.com/";
	update_option('enigma_options',$wl_theme_options);
}
...
function wl_reset_footer_footercall_setting () {
	...
	$wl_theme_options['fc_btn_txt']="enigma-parallax";
	$wl_theme_options['fc_btn_link']="http://enigma-parallax.com/";
	update_option('enigma_options',$wl_theme_options);
}
